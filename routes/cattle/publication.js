                ...
                connection.query(
                    ...
                    function (err, results) {
                        ...
                        if (err) {
                            ...
                            indexParams.lot.whatsappMessage =
                                encodeURIComponent(
                                    ...
                                    "https://equinos.agrooriental.uy/ganado/lote/publicacion/" + indexParams.lot.lotId
                                );

                            indexParams.lot.whatsappShare =
                                encodeURIComponent(
                                    "Te comparto el lote Nro. " + indexParams.lot.lotId +
