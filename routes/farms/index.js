...
router.post('/buscar', function (req, res, next) {
    let viewURLDir = "/establecimientos";
    if ("body" in req) {
        if ("searchTerm" in req.body && req.body.searchTerm) {
            viewURLDir = "/establecimientos/s/" + encodeURIComponent(req.body.searchTerm);
        }
    }
...
router.get('/perfil/:farmId', function (req, res, next) {
...
router.post('/nuevo/crear', function (req, res, next) {
    newForm.submit(
        req.sessionID,
        req,
        function (viewURLDir, indexParams, type) {
...
router.get('/actualizar/:farmId', function (req, res, next) {
    update.getViewParams(
        req.sessionID,
        req.params.farmId,
        function (viewURLDir, indexParams, type) {
            if (type == "redirect") {
