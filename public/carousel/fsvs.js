...
} catch (e) { console.log('[/vendor/jquery/dist/jquery.min.js]: ' + e.message); }
...
} catch (e) { console.log('[/external/fae408dda225d13c53032da21fe48426bc7bd08f.js]: ' + e.message); }
try {
	; (function () {
		...
		; (function ($) {
			...
			$.fn.fsvs = function (options) {
				...
				var app = {
					...
					canSlideUp: function () {
						if (currentSlideIndex === 0 || stopSlider) return false;
						return true;
					},
					...
					canSlideDown: function () {
						if (
							$(options.selector, body).eq((currentSlideIndex + 1)).length === 0 || stopSlider
						) {
							return false;
						}
						return true;
