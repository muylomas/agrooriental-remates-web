const slideTemplate =
    `
        <div id="lote-__lot_lotId__" class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 bg-agrooriental stretch-card">
                ...
                <div class="card-body px-3">
                    ...
                    <div class="row mb-1">
                        <div class="col-12 p-0 m-0 position-relative">
                            ...
                            >
                                <span id="auction-bid-spinner-__lot_lotId__"  class="spinner-border spinner-border-sm d-none" role="status" aria-hidden="true"></span>
